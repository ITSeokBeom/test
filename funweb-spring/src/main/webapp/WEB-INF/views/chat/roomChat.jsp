...
<!-- 		<div v-if="showChatting"> -->
			...
			<input type="text" v-model="message" v-on:focus="enter" v-on:keyup.enter="send" placeholder="채팅글을 입력하세요" autofocus>
...
// 			nickname: '', // 닉네임 사용 시
		...
		methods: {
			...
			connect: function () {
				webSocket = new WebSocket('wss://localhost:8082/chat');
